...
If you use RStudio, the most convienent way to track your mouse movement with `deviz` is to use the jobs pane. Just create somewhere a file like the following:
